...
CanvasRails::Application.routes.draw do
  ...
  post "icl_project_portal/mark_project"
  post "icl_project_portal/choose_indiv"
  post "icl_project_portal/choose_projects"
  ...
  post "icl_project_portal/create_project_with_params"
